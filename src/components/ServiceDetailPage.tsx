...
export default function ServiceDetailPage({ service }: ServiceDetailPageProps) {
  ...
  return (
    <PageShell>
      ...
      <section className="relative overflow-hidden pt-40 pb-24 bg-industrial-gray">
        ...
        <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-display font-extrabold text-primary mb-6 leading-[1.05]">
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              <button
                ...
                className="bg-primary text-white font-bold px-8 py-4 rounded-full hover:bg-slate-800 transition-all shadow-xl"
              >
                {service.hero.ctaLabel}
              </button>
              <div className="inline-flex items-center gap-2 bg-white border border-slate-200 text-primary px-5 py-4 rounded-full text-sm font-bold shadow-sm">
            ...
            {service.process.steps.map((step, index) => {
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ y: -10 }}
                  className="bg-white rounded-[32px] border border-slate-100 shadow-lg p-8"
                >
          ...
          <div className="bg-primary rounded-[30px] md:rounded-[50px] overflow-hidden relative">
            ...
            <div className="grid lg:grid-cols-2 gap-0 items-stretch relative z-10">
              ...
              <div className="bg-white p-8 md:p-12 lg:p-20 flex items-center justify-center">
                <div className="bg-industrial-gray rounded-[40px] p-10 border-2 border-slate-100 text-center max-w-lg w-full shadow-xl">
                  ...
                  <button
                    onClick={() => navigate('/contact')}
                    className="bg-primary text-white font-bold px-8 py-4 rounded-full hover:bg-slate-800 transition-all shadow-lg"
                  >
